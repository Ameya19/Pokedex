    ...
    return (
        <div id="pokemon-detail">
            ...
            <div>
                ...
                <div className="pokemon-detail-info" style={{ display: 'flex', flexDirection: isSmallScreen ? 'column' : 'row', justifyContent: 'space-around',height: isSmallScreen ? "67vh":"60vh", overflowY: 'hidden' }}>
